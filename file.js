...
document.getElementById('eventForm').addEventListener('submit',function(e){
    ...
    let textofEventLocation=eventLocation.value;
        ...
        paragraph.innerHTML = `
        <strong>Event Name: ${textofEventName}</strong><br>
        <strong>Date: ${textofEventDate}</strong><br>
        <strong>Time: ${textofEventTime}</strong><br>
        <strong>Location: ${textofEventLocation}</strong>
        `;
